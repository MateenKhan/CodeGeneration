...
public class UiComponent {
	...
	public static void main(String[] args) throws Exception {
		...
		createUiComponent(obj);

	}

	@SuppressWarnings("resource")
	public static File createUiComponent(JSONObject obj) throws Exception {
		File f = null;
		...
		try {
			...
			finalCode.append("import {").append(tableName).append("Service} from \"qCommon/app/services/")
